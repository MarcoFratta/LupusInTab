      ...
      <div class="bg-neutral-900/60 border border-neutral-800/40 rounded-lg p-3">
        <div class="flex items-center justify-between gap-2 whitespace-nowrap">
          <div class="flex items-center gap-2">
            <div class="w-7 h-7 bg-neutral-800/60 rounded flex items-center justify-center text-neutral-300">
        ...
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div class="text-slate-400 text-[11px]">
              {{ canStart ? 'Tutti i giocatori e i ruoli sono configurati' : (totalRolesSelected !== state.setup.numPlayers ? 'Il totale dei ruoli deve coincidere con i giocatori' : 'È richiesto almeno 1 lupo') }}
            </div>
          </div>
        </div>
