...
<template>
  <div class="w-full px-3 md:px-6 space-y-4 md:space-y-6">
    ...
    <div class="bg-neutral-900/60 border border-neutral-800/40 rounded-xl p-3 md:p-4">
      ...
      <div class="space-y-2">
        <div class="w-full bg-neutral-800/40 rounded-full h-2 overflow-hidden">
      ...
      <!-- Start Button -->
      <button class="group relative w-full mt-4 px-3 md:px-4 py-2 md:py-2.5 rounded-lg md:rounded-xl font-semibold text-sm md:text-base transition-all duration-300 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 overflow-hidden" 
              :class="canStart 
        ...
        <div class="relative px-2 z-10 flex items-center justify-center gap-1.5 md:gap-2">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-1">
              <div class="text-lg md:text-xl font-black leading-none tabular-nums" 
                   :class="totalRolesSelected === state.setup.players.length 
              ...
              <div class="text-lg md:text-xl font-bold leading-none text-neutral-400">/</div>
              <div class="text-lg md:text-xl font-bold leading-none text-neutral-200">{{ state.setup.players.length }}</div>
            </div>
          </div>
        </div>
