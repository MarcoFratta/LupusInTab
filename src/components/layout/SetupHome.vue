       ...
       <div class="flex items-center justify-between">
         <div class="flex items-center gap-2 md:gap-3">
           <div class="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-300"
                :class="totalRolesSelected === state.setup.numPlayers 
                  ? 'bg-gradient-to-br from-violet-500/30 to-fuchsia-500/30 border border-violet-400/50' 
                  : 'bg-gradient-to-br from-red-500/20 to-orange-500/20 border border-red-500/30'">
             <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                  :class="totalRolesSelected === state.setup.numPlayers ? 'text-violet-400' : 'text-red-400'">
           ...
           <div class="flex items-center gap-1 md:gap-2">
             ...
             <div class="text-xl md:text-2xl lg:text-3xl font-bold leading-none text-neutral-200">{{ state.setup.numPlayers }}</div>
           </div>
         </div>
