export default {
  ...
  phases: {
    ...
    revealRoles: "Role Reveal",
    resolve: "Night Resolution"
  },
  setup: {
    title: "Configuration",
    balance: "Balance",
  ...
  roles: {
    ...
    requestRoleDescription: "Request it by supporting the project!",
    requestRoleButton: "Click here to support"
  },
  settings: {
    title: "Settings",
    language: "Language",
    ...
    offerCoffee: "Click here to support",
    ...
    installAppButton: "Install on iOS",
    installIosInstructionsTitle: "iOS Installation Instructions",
    installIosStep1: "1. Tap the Share button at the bottom of Safari.",
  ...
  game: {
    ...
    gameInProgressDescription: "You currently have a game in progress.",
    resumeGame: "Resume Game",
    createNewGame: "Create New Game",
    cancelNewGame: "Cancel",
    confirmOverwriteTitle: "Overwrite Game in Progress?",
    confirmOverwriteText: "Starting a new game will erase progress of the current game. Are you sure you want to continue?",
  ...
  rolePrompts: {
    ...
    allWolvesDeadCanKill: "All wolves are dead: you can kill a player!",
    cannotSelectThreeAdjacent: "Cannot select 3 adjacent players",
  ...
  resolveDetails: {
    ...
    whoToReveal: "Who do you want to reveal the role to?",
    revealRole: "Reveal role",
    selectPlayerToRevealRole: "Select a player to review their role",
    checkFaction: "Check a player's faction",
    discovered: "Discovered that",
    noWolfAttacksToRedirect: "No wolf attacks to redirect",
    chooseTargetForWolves: "Choose a target for the wolves to devour",
  ...
  roleDetails: {
    ...
    noPlayerBlocked: "No player blocked",
    noTransformation: "No transformation",
    powerNotUsedDueToImbalance: "Power not used due to loss of balance between teams"
  },
